...
namespace DataJuggler.PixelDatabase
{
    ...
    public class PixelDatabase : IDisposable
    {
        ...
        #region Methods
            ...
            #region DrawRiver(Color color, DirectionEnum direction)
            /// <summary>
            /// This method Draw River
            /// </summary>
            public void DrawRiver(Color color, DirectionEnum direction)
            {  
                if (direction == DirectionEnum.LeftToRight)
                {
                    // Draw the river left to right
                    DrawRiverLeftToRight(color);
                }
                else if (direction == DirectionEnum.RightToLeft)
                {
                    // Draw the river right to left
                    DrawRiverRightToLeft(color);
                }
                else if (direction == DirectionEnum.TopToBottom)
                {   
                    // Driver Top To Bottom
                    DrawRiverTopToBottom(color);
                }
                else if (direction == DirectionEnum.BottomToTop)
                {
                    // Draw river bottom to top
                    DrawRiverBottomToTop(color);
                }
            }
            #endregion
            ...
            /// </summary>
            private void DrawRiverBottomToTop(Color color)
            {
                 // locals
                int x = 0;
                int y = this.Height;
